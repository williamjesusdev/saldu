...
export const editAccountSchema = z.object({
  ...
  ignoreInTotals: z.boolean(),
  investmentAccount: z.boolean(),
});
...
export function EditAccountForm({ initialData, onSubmit, isLoading = false }: Readonly<Props>) {
  ...
  const [formData, setFormData] = useState<Partial<EditAccountFormData>>({
    ...
    >
      <div>
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-xl font-semibold text-slate-100">Editar Conta</h2>
        </div>
        <p className="mt-2 text-sm text-slate-400">Atualize os detalhes da conta bancária.</p>
      </div>
            ...
            <div className="relative flex items-start">
              <div className="flex h-6 items-center">
                <input
                  ...
                  onChange={handleChange}
                  checked={formData.ignoreInTotals}
            ...
            <div className="relative flex items-start">
              <div className="flex h-6 items-center">
                <input
                  ...
                  onChange={handleChange}
                  checked={formData.investmentAccount}
                  className="h-4 w-4 rounded border-slate-700 bg-slate-950 text-emerald-500 focus:ring-emerald-500 focus:ring-offset-slate-900"
                />
              </div>
              <div className="ml-3 text-sm/6">
